        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('class')
                    ...
                    ->children()
                        ->scalarNode('tag')
                            ->defaultValue('Application\\Sonata\\ClassificationBundle\\Document\\Tag')
                        ->end()
                        ->scalarNode('collection')
                            ->defaultValue('Application\\Sonata\\ClassificationBundle\\Document\\Collection')
                        ->end()
                        ->scalarNode('post')
                            ->defaultValue('Application\\Sonata\\NewsBundle\\Document\\Post')
                        ->end()
                        ->scalarNode('comment')
                            ->defaultValue('Application\\Sonata\\NewsBundle\\Document\\Comment')
                        ->end()
                        ->scalarNode('media')
                            ->defaultValue('Application\\Sonata\\MediaBundle\\Document\\Media')
                        ->end()
                        ->scalarNode('user')
                            ->defaultValue('Application\\Sonata\\UserBundle\\Document\\User')
                        ->end()
                    ->end()
                ->end()
